  ...
  methods: {
    initLineChart() {
      ...
      chart.setOption({
        ...
        legend: { data: ["网络", "终端", "数据库审计"] },
        grid: { left: "5%", right: "5%", bottom: "10%", containLabel: true },
        xAxis: { type: "category", data: hours },
        yAxis: { type: "value" },
        series: [
          { name: "网络", type: "line", smooth: true, data: network },
          { name: "终端", type: "line", smooth: true, data: terminal },
          { name: "数据库审计", type: "line", smooth: true, data: database }
        ]
      });
    }
  }
