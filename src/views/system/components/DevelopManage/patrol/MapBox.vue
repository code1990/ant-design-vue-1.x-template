...
import LeftBox from '@/views/system/components/DevelopManage/patrol/LeftBox.vue'
import RightBox from '@/views/system/components/DevelopManage/patrol/RightBox.vue'
import HeaderBox from '@/views/system/components/DevelopManage/patrol/HeaderBox.vue'
