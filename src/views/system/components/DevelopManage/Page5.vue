<template>
  <div>
    ...
    <div class="tdt-iconLayers tdt-iconLayers_topright tdt-control" style="right: calc(100% - 1345px);top: 300px;position: absolute;">
      <div class="tdt-iconLayers-layersRow">
        <div
          class="tdt-iconLayers-layerCell tdt-iconLayers-layerCell_expandLeft tdt-iconLayers-layerCell_hidden"
          data-layerid="500">
          <div class="tdt-iconLayers-layer" data-layerid="499" style="background-image: url('https://api.tianditu.gov.cn/v4.0/image/map/maptype/terrainpoi.png')">
            <div class="tdt-iconLayers-layerTitleContainer">
              <div class="tdt-iconLayers-layerTitle">
                3D地图
              </div>
            </div>
            <div class="tdt-iconLayers-layerCheckIcon">
            </div>
          </div>
        </div>
        <div
        ...
        <div
          class="tdt-iconLayers-layerCell tdt-iconLayers-layerCell_expandLeft tdt-iconLayers-layerCell_hidden"
          data-layerid="498">
          <div class="tdt-iconLayers-layer" data-layerid="498" style="background-image: url('https://api.tianditu.gov.cn/v4.0/image/map/maptype/terrain.png')">
            <div class="tdt-iconLayers-layerTitleContainer">
              <div class="tdt-iconLayers-layerTitle">
                地形
              </div>
        ...
        <div
          class="tdt-iconLayers-layerCell tdt-iconLayers-layerCell_expandLeft tdt-iconLayers-layerCell_hidden"
          data-layerid="497">
          <div class="tdt-iconLayers-layer" data-layerid="497" style="background-image: url('https://api.tianditu.gov.cn/v4.0/image/map/maptype/satellitepoi.png')">
            <div class="tdt-iconLayers-layerTitleContainer">
              <div class="tdt-iconLayers-layerTitle">
                卫星混合
              </div>
        ...
        <div
          class="tdt-iconLayers-layerCell tdt-iconLayers-layerCell_active tdt-iconLayers-layerCell_expandLeft tdt-iconLayers-layerCell_hidden"
          data-layerid="495">
          <div class="tdt-iconLayers-layer" data-layerid="495" style="background-image: url('https://api.tianditu.gov.cn/v4.0/image/map/maptype/vector.png')">
            <div class="tdt-iconLayers-layerTitleContainer">
              <div class="tdt-iconLayers-layerTitle">
                地图
              </div>
        ...
        <div
          class="tdt-iconLayers-layerCell tdt-iconLayers-layerCell_expandLeft"
          data-layerid="496">
          <div class="tdt-iconLayers-layer" data-layerid="496" style="background-image: url('https://api.tianditu.gov.cn/v4.0/image/map/maptype/satellite.png')">
            <div class="tdt-iconLayers-layerTitleContainer">
              <div class="tdt-iconLayers-layerTitle">
                卫星
              </div>
